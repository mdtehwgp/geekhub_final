...
Revision ID: 71ba54fe828f
Revises: 
Create Date: 2017-04-21 15:57:02.413704
...
def upgrade():
    ...
    sa.Column('performance_story_points', sa.Integer(), nullable=True),
    ...
    sa.Column('task_story_points', sa.Integer(), nullable=True),
    ...
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['followed_id'], ['posts.id'], ),
